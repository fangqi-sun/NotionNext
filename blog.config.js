...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '方应', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '喜欢分享免费有趣实用，最好能够白嫖的软件。谢谢关注！', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.fangyingsat.top', // 网站地址
  ...
  SEO_GOOGLE_SITE_VERIFICATION:
        process.env.NEXT_PUBLIC_SEO_GOOGLE_SITE_VERIFICATION || 'F4-npXVZEZvZeOko-CgyZ6MsJHP_862vIzwsxjyAhhs', // Remove the value or replace it with your own google site verification code

  // 百度站长平台的站点验证 
  SEO_BAIDU_SITE_VERIFICATION:
        process.env.NEXT_PUBLIC_SEO_BAIDU_SITE_VERIFICATION || 'codeva-wOELQo6LJq', // Remove the value or replace it with your own google site verification code
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-6322864209100636', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
