const CONFIG = {
  ...
  HERO_CATEGORY_2: { title: '资源分享', url: '/tag/资源分享' },
  HERO_CATEGORY_3: { title: '安卓合集', url: '/tag/安卓' },

  // 英雄区右侧推荐文章标签, 例如 [推荐] , 最多六篇文章; 若留空白''，则推荐最近更新文章
  HERO_RECOMMEND_POST_TAG: '影视',
  ...
  SOCIAL_CARD_TITLE_2: '加入社群讨论分享',
  SOCIAL_CARD_TITLE_3: '点击加入社群',
  SOCIAL_CARD_URL: 'https://www.fangyingsat.top/example-2',
